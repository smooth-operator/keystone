...
/**
 * group FieldType Constructor
 * @extends Field
 * @api public
 */

function group(list, path, options) {
	...
	group.super_.call(this, list, path, options);
...
group.prototype.addToSchema = function() {
 ...
 * @api public
 */
group.prototype.format = function(item) {
...
group.prototype.validateInput = function(data, required, item) {
...
group.prototype.updateItem = function(item, data) {
	...
	if (item.populated(this.path)) {
		throw new Error('fieldTypes.group.updateItem() Error - You cannot update populated groups.');
	}
...
/**
 * Returns true if the group configuration is valid
 *
 * @api public
 */

Object.defineProperty(group.prototype, 'isValid', {
	get: function() {
...
Object.defineProperty(group.prototype, 'refList', {
	get: function() {
...
Object.defineProperty(group.prototype, 'hasFilters', {
	get: function() {
...
/**
 * Adds group filters to a query
 *
 * @api public
 */

group.prototype.addFilters = function(query, item) {
