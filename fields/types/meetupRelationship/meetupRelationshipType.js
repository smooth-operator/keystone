...
function meetupRelationship(list, path, options) {
	...
	meetupRelationship.super_.call(this, list, path, options);
...
util.inherits(meetupRelationship, super_);

/**
 * Get client-side properties to pass to react field.
 */

meetupRelationship.prototype.getProperties = function () {
...
meetupRelationship.prototype.addToSchema = function() {
 ...
 * @api public
 */
meetupRelationship.prototype.format = function(item) {
...
meetupRelationship.prototype.validateInput = function(data, required, item) {
...
meetupRelationship.prototype.updateItem = function(item, data) {
	...
	if (item.populated(this.path)) {
		throw new Error('fieldTypes.meetupRelationship.updateItem() Error - You cannot update populated meetupRelationships.');
	}
...
/**
 * Returns true if the meetupRelationship configuration is valid
 *
 * @api public
 */

Object.defineProperty(meetupRelationship.prototype, 'isValid', {
	get: function() {
...
Object.defineProperty(meetupRelationship.prototype, 'refList', {
	get: function() {
...
Object.defineProperty(meetupRelationship.prototype, 'hasFilters', {
	get: function() {
...
/**
 * Adds meetupRelationship filters to a query
 *
 * @api public
 */

meetupRelationship.prototype.addFilters = function(query, item) {
...
exports = module.exports = meetupRelationship;
