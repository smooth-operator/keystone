...
/**
 * owner FieldType Constructor
 * @extends Field
 * @api public
 */

function owner(list, path, options) {
	...
	owner.super_.call(this, list, path, options);
...
util.inherits(owner, super_);

/**
 * Get client-side properties to pass to react field.
 */

owner.prototype.getProperties = function () {
...
owner.prototype.addToSchema = function() {
 ...
 * @api public
 */
owner.prototype.format = function(item) {
...
owner.prototype.validateInput = function(data, required, item) {
...
owner.prototype.updateItem = function(item, data) {
	...
	if (item.populated(this.path)) {
		throw new Error('fieldTypes.owner.updateItem() Error - You cannot update populated owners.');
	}
...
/**
 * Returns true if the owner configuration is valid
 *
 * @api public
 */

Object.defineProperty(owner.prototype, 'isValid', {
	get: function() {
...
Object.defineProperty(owner.prototype, 'refList', {
	get: function() {
...
Object.defineProperty(owner.prototype, 'hasFilters', {
	get: function() {
...
/**
 * Adds owner filters to a query
 *
 * @api public
 */

owner.prototype.addFilters = function(query, item) {
